    ...
    <div class="container">
      ...
      <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <ul class="navbar-nav ms-auto">
          <li class="nav-item">
            <a class="nav-link active" href="tambah2.php">Tambah Data</a>
          </li>
          <li class="nav-item">
            ...
            <tbody>
                <?php $i=1; foreach ($sma as $akhir) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="ubah2.php?id=<?= $akhir["id"]; ?>" class="btn badge bg-primary">Ubah</a>
                            <a href="hapus2.php?id=<?= $akhir["id"]; ?>" class="btn badge bg-danger" onclick="return confirm('Yang Beneeerrr');">Hapus</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
