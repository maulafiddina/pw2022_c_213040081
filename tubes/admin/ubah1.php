    ...
    <div class="container">
        ...
        <div class="row mt-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nama" name="nama" required value="<?= $awal["nama"]; ?>">
            </div>

            <div class="mb-3">
                <label for="npm" class="from-label">Deskripsi</label>
                <input type="text" class="form-control" id="deskripsi" name="deskripsi" required value="<?= $awal["deskripsi"]; ?>" >
            </div>

            <div class="mb-3">
                <label for="email" class="from-label">link</label>
                <input type="text" class="form-control" id="link" name="link" required value="<?= $awal["link"]; ?>">
            </div>

            <div class="mb-3">
                <label for="gambar" class="from-label">Gambar</label>
                <input type="text" class="form-control" id="gambar" name="gambar" required value="<?= $awal["gambar"]; ?>">
            </div>
